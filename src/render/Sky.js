...
export const ZONES = {
  ...
  cortex: {
    sky: () => T.nebula,
    tint: 0x2a0a10, exposure: 0.80, drift: 0.0006,
    fog: 0x140306, fogDensity: 0.0038,
    ambient: 0x6a5064, ground: 0x2e1a20, ambientI: 1.25,
    sun: 0xffd8cc, sunI: 1.25, sunDir: [0.25, 0.66, 0.71],
    fill: 0xff5a44, fillI: 0.42,
    music: 'combat',
  },
  altar: {
    sky: () => T.skyIndigo,
    tint: 0xffffff, exposure: 0.96, drift: 0.0008,
    fog: 0x121028, fogDensity: 0.0055,
    ambient: 0x6a5f9c, ground: 0x2e2438, ambientI: 1.20,
    sun: 0xcfd8ff, sunI: 1.05, sunDir: [0.42, 0.62, 0.66],
    fill: 0xff9a5a, fillI: 0.45,
    music: 'nexus',
  },
  atrium: {
    sky: () => T.skyIndigo,
